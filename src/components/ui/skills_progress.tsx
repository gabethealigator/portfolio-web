        ...
        <div className="flex flex-col gap-11">
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <FaReact />
                <div className="items-center text-lg">React</div>
              </div>
          ...
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <BiLogoTypescript />
                <div className="items-center text-lg">TypeScript</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{tsSkillLevel}%</p>
              </div>
          ...
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <BiLogoJavascript />
                <div className="items-center text-lg">JavaScript</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{jsSkillLevel}%</p>
              </div>
          ...
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <BiLogoCss3 />
                <div className="items-center text-lg">Css3</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{cssSkillLevel}%</p>
              </div>
          ...
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <BiLogoHtml5 />
                <div className="items-center text-lg">Html5</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{htmlSkillLevel}%</p>
              </div>
          ...
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <BiLogoFlutter />
                <div className="items-center text-lg">Flutter</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{flutterSkillLevel}%</p>
              </div>
            </div>
            <div className="flex justify-start w-full items-center">
        ...
        <div className="flex flex-col gap-11">
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <GrArchlinux />
                <div className="items-center text-lg">Linux</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{linuxSkillLevel}%</p>
              </div>
          ...
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <BiLogoDjango />
                <div className="items-center text-lg">Django</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{djangoSkillLevel}%</p>
              </div>
            </div>
            <div className="flex justify-start w-full items-center">
          ...
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <BiLogoPython />
                <div className="items-center text-lg">Python</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{pythonSkillLevel}%</p>
              </div>
            </div>
            <div className="flex justify-start w-full items-center">
          ...
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <TbFileTypeSql />
                <div className="items-center text-lg">Tsql</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{tsqlSkillLevel}%</p>
              </div>
          ...
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <BiLogoFirebase />
                <div className="items-center text-lg">Firebase</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{fireBaseSkillLevel}%</p>
              </div>
            </div>
            <div className="flex justify-start w-full items-center">
        ...
        <div className="flex flex-col gap-11">
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <IoHardwareChip />
                <div className="items-center text-lg">Esp32</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{esp32SkillLevel}%</p>
              </div>
          ...
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <BiLogoCPlusPlus />
                <div className="items-center text-lg">C++</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{cppSkillLevel}%</p>
              </div>
          ...
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <SiArduino />
                <div className="items-center text-lg">Arduino</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{arduinoSkillLevel}%</p>
              </div>
            </div>
            <div className="flex justify-start w-full items-center">
          ...
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <FaMicrochip />
                <div className="items-center text-lg">Firmware</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{firmwareSKillLevel}%</p>
              </div>
            </div>
            <div className="flex justify-start w-full items-center">
          ...
          <div className="flex items-center gap-4 flex-col">
            <div className="flex items-center justify-between w-full">
              <div className="text-4xl flex gap-1 items-center">
                <VscRadioTower />
                <div className="items-center text-lg">IOT</div>
              </div>
              <div className="text-[1rem] font-semibold">
                <p>{iotSkillLevel}%</p>
              </div>
